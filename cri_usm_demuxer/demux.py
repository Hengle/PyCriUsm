...
class UsmDemuxer:
	def __init__(self, video_path, key=0, encrypted_audio=False):
	...
	def export(self, output_path: str, chunk_filter_config=None):
		...
		if chunk_filter_config is None:
			chunk_filter_config = {ChunkType.AUDIO: {PayloadType.STREAM: None}, ChunkType.VIDEO: {PayloadType.STREAM: None}}
